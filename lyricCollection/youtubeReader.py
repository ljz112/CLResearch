...
def getYoutubePopularity(name, artist):
    # Example: Search for videos related to a certain query
    search_query = name + " --- " + artist # Replace with your search query, should be in a parsable format
    songName = search_query.split('---')[0].strip().lower()
    resultLimit = 5
    popSum = 0
...
# name, artist = ["Outro", "EAZ"]
# getYoutubePopularity(name, artist)